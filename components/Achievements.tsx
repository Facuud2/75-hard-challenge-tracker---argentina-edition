        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-purple-500/20">
            <div className="flex items-center gap-2 sm:gap-3">
              <Icon name="trophy" className="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" />
          ...
          <div className={`p-4 sm:p-6 border-b border-purple-500/20 ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="text-center">
                <div className={`text-2xl sm:text-3xl font-bold ${theme === 'dark' ? 'text-purple-300' : 'text-purple-700'}`}>
                  {unlockedCount}
                </div>
              ...
              <div className="text-center">
                <div className={`text-2xl sm:text-3xl font-bold ${theme === 'dark' ? 'text-yellow-300' : 'text-yellow-700'}`}>
                  {totalPoints}
                </div>
                <div className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                  Puntos Totales
              ...
              <div className="text-center">
                <div className={`text-2xl sm:text-3xl font-bold ${theme === 'dark' ? 'text-green-300' : 'text-green-700'}`}>
          ...
          {/* Category Filter */}
          <div className="flex flex-wrap gap-2 p-4 border-b border-purple-500/20">
            {[
          ...
          {/* Achievements Grid */}
          <div className="flex-1 overflow-y-auto p-4 max-h-[calc(90vh-280px)] scrollbar-thin scrollbar-thumb-purple-500/20 scrollbar-track-transparent hover:scrollbar-thumb-purple-500/40">
                ...
                >
                  ...
                  <div className={`relative rounded-2xl border-2 p-4 transition-all duration-300 ${
                    ...
                    <div className="absolute top-2 right-2">
                      <span className={`text-lg font-bold ${getRarityTextColor(achievement.rarity)}`}>
          ...
          {/* Actions */}
          <div className="flex justify-end p-4 sm:p-6 border-t border-purple-500/20">
            <button
              onClick={onClose}
